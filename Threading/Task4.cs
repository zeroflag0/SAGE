...
namespace Sage.Threading
{
	...
	{
		public delegate void CallHandler(T1 p1, T2 p2, T3 p3, T4 p4);
		...
		T3 _Param3;
		/// <summary>
		/// The 3. Parameter for the Message.
		/// </summary>
		public T3 Param3
		{
			get { return _Param3; }
		...
		T4 _Param4;
		/// <summary>
		/// The 4. Parameter for the Message.
		/// </summary>
		public T4 Param4
		{
			get { return _Param4; }
		...
		public Task(T1 p1, T2 p2, T3 p3, T4 p4)
		{
			this.Param1 = p1;
			this.Param2 = p2;
			this.Param3 = p3;
		...
		public Task(CallHandler call, T1 p1, T2 p2, T3 p3, T4 p4)
			: this(p1, p2, p3, p4)
		{
			this.Call += call;
		}
		...
		public virtual void Run()
		{
			...
			{
				// call them...
				this._Call(this.Param1, this.Param2, this.Param3, this.Param4);
			}
		}
