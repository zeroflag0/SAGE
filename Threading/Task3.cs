...
namespace Sage.Threading
{
	...
	{
		public delegate void CallHandler(T1 p1, T2 p2, T3 p3);
		...
		public Task(CallHandler call, T1 p1, T2 p2, T3 p3)
			: this(p1, p2, p3)
		{
			this.Call += call;
		}
		...
		public virtual void Run()
		{
			...
			{
				// call them...
				this._Call(this.Param1, this.Param2, this.Param3);
			}
		}
