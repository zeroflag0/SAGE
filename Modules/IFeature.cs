...
namespace Sage.Modules
{
	public interface IFeature
	{
		...
		void OnMove(Vector v);
		void OnRotate(double w, double x, double y, double z);
		void OnRotate(Quaternion q);
		void OnScale(Vector v);
		void OnScale(double x, double y, double z);
		/// <summary>
		/// The type of the module that provided the feature.
		/// </summary>
		Type ModuleType { get; }
		/// <summary>
